...
namespace dif_codesystem_code
{
    internal class ConsoleOutput
    {
        ...
        public static void GetInput()
        {
            ...
            Console.WriteLine("Explanation: Fisrt, you select the number system that your input is based on. Second you select the nu,mber system you want your text to get encrypted to. Latly you enter the number code you want ot encrypt. Press enter and your newly encrypted number code get displayed!");
            ...
            string UserInputStartNumberSystem = Console.ReadLine();   //if else logik machen? oder mit schleife arbieten? 
